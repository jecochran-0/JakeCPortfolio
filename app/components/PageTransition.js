...
export function NavigationProvider({ children }) {
  ...
  const brandColors = [
    {
      name: "primary",
      bg: "bg-orange-400", // #fb923c - lighter orange
      shadow: "rgba(251, 146, 60, 0.7)",
      shadowSecondary: "rgba(251, 146, 60, 0.3)",
    ...
    {
      name: "accent",
      bg: "bg-blue-500", // #3b82f6 - brighter blue
      shadow: "rgba(59, 130, 246, 0.7)",
      shadowSecondary: "rgba(59, 130, 246, 0.3)",
      shine: "via-blue-200",
  ...
  const getColorForPath = () => {
    // Use random selection for truly random colors on each navigation
  ...
  const navigate = (path) => {
    ...
    const destinationColor = getColorForPath();
...
export default function PageTransition({ children }) {
  ...
  return (
    <>
      ...
      {/* Performance-Optimized Navigation Transition - Desktop Only */}
